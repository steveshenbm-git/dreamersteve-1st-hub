...
CUSTOMER_DISCOVERY_READINESS_STATES = [
    "ready_for_direction_compilation",
    "ready_for_limited_direction_validation",
    "needs_application_evidence",
    "blocked",
]
DISCOVERY_MODE_STATES = ["full_direction_compilation", "limited_direction_validation"]
EVIDENCE_ROLE_STATES = ["application_seed", "direction_holdout", "counterevidence"]
...
CONTROLLED_VALIDATIONS = {
    ...
    ("路线评审", "customer_discovery_readiness"): ("V3:V200", CUSTOMER_DISCOVERY_READINESS_STATES),
    ("开发方向", "external_validation_status"): ("I3:I5000", EXTERNAL_VALIDATION_STATES),
    ("开发方向", "direction_status"): ("J3:J5000", DIRECTION_STATES),
    ("开发方向", "discovery_mode"): ("Q3:Q200", DISCOVERY_MODE_STATES),
    ("方向证据", "evidence_state"): ("J3:J5000", EVIDENCE_STATES),
    ("方向证据", "evidence_role"): ("M3:M500", EVIDENCE_ROLE_STATES),
