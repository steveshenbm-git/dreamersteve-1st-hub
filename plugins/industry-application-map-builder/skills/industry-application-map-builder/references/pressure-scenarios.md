...
| R4-P90 | content-first 合同缺 `created_at`、owner authorization、skill Git commit 或配套 director 版本，但仍被锁定 | FAIL | 补全真实创建时间、用户授权引用、当前技能提交和 `0.3.0-beta.4` director 版本，用新合同重锁。 |
