...
Use this guide when a composition is based on one simple element, feels visually thin, or fails review despite being technically clean.

## First Diagnosis

Identify the real problem before adding anything:
...
| Too decorative | Added lines or glows lack purpose | Remove them and rebuild hierarchy through scale and contrast |
...
For every multi-subject visual, write one internal sentence before production:

> **[Foundation]** enables **[Driver]**, which produces **[Outcome]**, and **[Flow]** shows how value moves or returns.

If that sentence cannot be completed from verified user input, ask what the image should demonstrate before choosing geometry.

Translate the sentence into visual behavior:

- **Foundation:** supporting plane, stable field, source, anchor, or input layer
- **Driver:** strongest contrast, active transformation, directional movement, or central force
- **Outcome:** resolved output, accessible touchpoint, delivered result, or sustained continuation
- **Flow:** transfer, amplification, feedback, return path, sequence, or closed loop
...
- **Parallel convergence:** use when equal capabilities combine into one output.
- **Sequential process:** use when the buyer experiences clear stages.
- **Closed-loop system:** use when observation, action, delivery, and feedback repeat.
- **Core and orbit:** use when one capability is primary and others continuously support it.
...
5. **Contrast:** Use one dominant contrast: light/dark, solid/transparent, precise/soft, static/energetic.
6. **Rhythm:** Introduce controlled repetition or progression.
7. **Material:** Add restrained physical cues only when they support industrial credibility.
...
Ask one question in this format:

> The current content can support a minimal design, but it may remain visually thin. May I add **[specific addition]** to create **[specific hierarchy or meaning]**?

Do not ask a broad question such as “Do you want more elements?”

## Content Adjustment Options

When visual design alone cannot solve the brief, propose one relevant option:

- shorten or regroup the existing words
- add a small category label or one-line explanation
...
1. Inspect supplied brand references or strong existing project assets.
2. Research current high-quality visual references when current information matters.
3. Ask the user for a reference image, product photo, preferred campaign, or disliked example.
4. With explicit permission, use an independent reviewer or specialist agent and provide the raw brief and rendered asset without revealing the intended verdict.

Additional help should challenge the concept, not merely confirm it.
